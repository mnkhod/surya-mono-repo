/*
  ...
  - You are about to drop the column `userId` on the `InformationTutor` table. All the data in the column will be lost.
  - Added the required column `rootUserId` to the `InformationTutor` table without a default value. This is not possible if the table is not empty.
