...
INSERT INTO "new_InformationStudent" ("createdAt", "firstName", "id", "lastName", "learningLanguages", "nativeLanguage", "profileImageLink", "remainingPurchase", "rootUserId", "updatedAt") SELECT "createdAt", "firstName", "id", "lastName", "learningLanguages", "nativeLanguage", "profileImageLink", "remainingPurchase", "rootUserId", "updatedAt" FROM "InformationStudent";
