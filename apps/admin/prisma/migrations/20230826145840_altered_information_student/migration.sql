...
INSERT INTO "new_InformationStudent" ("createdAt", "firstName", "id", "lastName", "learningLanguages", "nativeLanguage", "profileImageLink", "remainingDemo", "remainingPurchase", "rootUserId", "updatedAt") SELECT "createdAt", "firstName", "id", "lastName", "learningLanguages", "nativeLanguage", "profileImageLink", "remainingDemo", coalesce("remainingPurchase", 0) AS "remainingPurchase", "rootUserId", "updatedAt" FROM "InformationStudent";
