...
import CreateGroupLessonForm from "@/components/tutor/GroupSchedules/CreateGroupLessonForm";
        ...
        <div className="card-body w-full flex gap-6 flex-col justify-between">
          <div className="tabs">
            ...
            <button
              ...
              className={`tab tab-lifted ${tabIndex == 4 && "tab-active"
                } font-bold`}
            >
              Create lesson group
            </button>
          ...
          {tabIndex == 4 && <CreateGroupLessonForm/>}
        </div>
      </div>
    </AdminLayout>
  )
